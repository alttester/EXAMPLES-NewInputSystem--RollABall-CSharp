...
public class BuildRollABall
{
    ...
    protected static void MacBuildFromCommandLine()
    {
        try
        {
            ...
            var buildPlayerOptions = GetBuildPlayerOptions("RollABall", BuildTarget.StandaloneOSX);
            buildGame(buildPlayerOptions, BuildTargetGroup.Standalone);
    ...
    public static void SetCommonSettings(BuildTargetGroup targetGroup)
    {
        ...
        PlayerSettings.SetApplicationIdentifier(targetGroup, "com.altom.RollABall");
